...
The game should include:
    ...
    [x]Intro screen briefly describing the game and explaining the controls (also include who created this game; group name or individual names and give your game a name).
